    ...
    <main style={{ minHeight: "100vh", fontFamily: "'Satoshi', Arial, sans-serif" }}>
      ...
      <section style={{ padding: isMobile ? "16px 18px 0" : "24px 48px 0" }}>
        <header style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center", position: "relative" }}>
          ...
          {isSignedIn && (
            <div style={{ position: "absolute", left: "50%", transform: "translateX(-50%)", fontSize: 20, letterSpacing: ".18em", textTransform: "uppercase", fontWeight: 800, color: pageText(theme), pointerEvents: "none", userSelect: "none", whiteSpace: "nowrap" }}>
              Boardtivity
            </div>
          )}
