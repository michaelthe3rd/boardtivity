  ...
  return (
    <LegalPage title="Privacy Policy" lastUpdated="April 5, 2026">
      ...
      <ul style={ul}>
        ...
        <li><strong>Stripe</strong> — payment processing. <a href="https://stripe.com/privacy" style={a}>stripe.com/privacy</a></li>
        <li><strong>Resend</strong> — email delivery. <a href="https://resend.com/legal/privacy-policy" style={a}>resend.com/legal/privacy-policy</a></li>
      </ul>
...
const h3: React.CSSProperties = { fontSize: 15, fontWeight: 700, marginTop: 24, marginBottom: 6, color: "var(--legal-text)" };
